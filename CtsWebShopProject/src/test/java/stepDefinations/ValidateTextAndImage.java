...
public class ValidateTextAndImage extends Base {
	final static Logger log = LogManager.getLogger(ValidateTextAndImage.class.getName());
	...
	public void verify_that_user_is_able_to_see_the_Feature_Products_text_is_present_in_the_home_page_or_not()
			throws Throwable {
		ValidatePage vp = new ValidatePage(driver);
		String actualtitle = vp.getTitle();
	...
	public void verify_that_user_is_able_to_see_the_demo_webshop_image_is_present_in_the_home_page_or_not()
			throws Throwable {
		ValidatePage vp = new ValidatePage(driver);
